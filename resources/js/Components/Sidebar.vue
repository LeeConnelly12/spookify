...
<template>
  <aside class="w-64 py-6 pl-6 bg-black">
    <nav class="grid text-sm">
      <Link href="/" class="text-2xl font-bold">Spookify</Link>
      <div class="mt-6 font-bold">
        <Link href="/" :class="route().current('home') ? 'opacity-100' : 'opacity-70'" class="flex items-center h-10 gap-4 transition-opacity duration-300 hover:opacity-100">
        ...
        <Link href="/search" class="flex items-center h-10 gap-4 transition-opacity duration-300 opacity-70 hover:opacity-100">
          <svg fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-7 w-7">
            <path stroke-linecap="round" stroke-linejoin="round" d="M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 5.196a7.5 7.5 0 0010.607 10.607z" />
          </svg>
          Search
        </Link>
        <Link href="/playlists" class="flex items-center h-10 gap-4 transition-opacity duration-300 opacity-70 hover:opacity-100">
          <svg fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-7 w-7">
      ...
      <div class="mt-6 font-bold">
        ...
        <Link href="/songs" :class="route().current('songs') ? 'opacity-100' : 'opacity-70'" class="flex items-center h-10 gap-4 transition-opacity duration-300 hover:opacity-100">
