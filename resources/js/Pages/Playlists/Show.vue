...
<template>
  <Layout>
    ...
    <table class="mt-4 w-full text-left text-gray-300">
      ...
      <tbody>
        <tr v-for="(song, index) in playlist.songs" class="group bg-gray-100 bg-opacity-0 hover:bg-opacity-10">
          ...
          <td class="relative flex h-16 items-center px-6 text-sm">
            <button type="button" class="absolute -left-5 hidden group-hover:block">
              <svg viewBox="0 0 24 24" fill="none" stroke-width="1.5" class="h-6 w-6 stroke-white">
